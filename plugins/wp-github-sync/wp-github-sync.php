...
class WordPress_GitHub_Sync {
	...
	public function boot() {
		...
		//add_action( 'wp_ajax_nopriv_wpghs_sync_request', array( $this->controller, 'import_master' ) );
		add_action( 'wp_ajax_nopriv_wpghs_sync_request', array( $this->controller, 'import_local_git' ) );
